...
<div class="row" style="max-width: 100%">
            <div class="col-md-12">
              <br><br>
                  <a  data-toggle="modal" href="#myModal" class="pull-right btn-sm btn btn-default" style="background-color:#337ab7;border-color: #2e6da4;color:#fff">Agregar Categoria</a>
  <!-- Button trigger modal -->

  <!-- Modal   aaaaaaaaaaaaaaaaaaaaaaaaaaaaagregar categoriaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
...
<!----------------------------- editar categoriaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa--->
 ...
 &nbsp; <div class="col-md-12">
  ...
  <td><div class="table-responsive">
     ...
     <a href="" target="_blank" class="btn btn-default btn-xs"><img style="width: 12px;"  src="<?php echo base_url("/assets/icocat/ojo.png"); ?>"></i></a>
          ...
          <td>
           <h4 style="color: #2e6da4;cursor: pointer;"><?php echo $fila->cat_title?></h4>
                       </td>
                       <td style="width:90px;">
...
foreach ($consulta->result() as $fila): ?>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      ...
      <input type="text" required class="form-control" name="cat_title" value="<?=$fila->cat_title   ?>" placeholder="Nombre de la categoria"> 
    </div>
  </div>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Nombre Corto</label>
    <div class="col-lg-10">
      <input type="text" required class="form-control" value="<?=$fila->short_name?>" name="short_name" placeholder="Nombre corto">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="category_id" value="">
      <button type="submit" class="btn btn-block btn-success">Actualizar Categoria</button>
                        ...
                        <a href="<?php echo base_url("deletecat_model"); ?>deletecat_model?cat_id=<?php echo $fila->cat_id; ?>"class="btn btn-danger btn-xs"><img style="width: 12px;"  src="<?php echo base_url("/assets/icocat/basura.png"); ?>"></i></a> 
                        </td>
                        </tr>
